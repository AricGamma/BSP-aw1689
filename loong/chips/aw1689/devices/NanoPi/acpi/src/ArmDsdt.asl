...
// Index 3
    			...
    			GpioIO(Shared, PullUp, 0, 0, IoRestrictionNone, "\\_SB.PIOD", 0, ResourceConsumer, , ) { 5 }
                GpioInt(Edge, ActiveBoth, Shared, PullUp, 0, "\\_SB.PIOD",)                            { 5 }

    			GpioIO(Shared, PullUp, 0, 0, IoRestrictionNone, "\\_SB.PIOD", 0, ResourceConsumer, , ) { 6 }
                GpioInt(Edge, ActiveBoth, Shared, PullUp, 0, "\\_SB.PIOD",)                            { 6 }

        		GpioIO(Shared, PullUp, 0, 0, IoRestrictionNone, "\\_SB.PIOD", 0, ResourceConsumer, , ) { 7 }
        		GpioInt(Edge, ActiveBoth, Shared, PullUp, 0, "\\_SB.PIOD",)                            { 7 }
           		...
           		GpioIO(Shared, PullUp, 0, 0, IoRestrictionNone, "\\_SB.PIOD", 0, ResourceConsumer, , ) { 24 }
           		GpioInt(Edge, ActiveBoth, Shared, PullUp, 0, "\\_SB.PIOD",)                            { 24 }
